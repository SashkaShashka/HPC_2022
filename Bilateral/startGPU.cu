...
using namespace std;
// G массив рассто€ний между пикселами
// arrayOutput выходной массив
// texObj куда текстура
// _width - width image
// _ height - height image
// sigmaR - параметр sirmaR
...
void draw_frame() {
	// любой символ который может сделать рамку, оставлю 201, т.к. корректного отображени€ расширенной ASCII в этой консоли нет
	cout << char(201);
...
{
// мб можно заменить на cout, не знаю что за stderr, мне лень читать (извините) -_-
...
int main(int argc, char* argv[])
{
	...
	texDesc.addressMode[0] = cudaAddressModeClamp; // «а границей текстуры будет продолжатьс€ граничное значение
